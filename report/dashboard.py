...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        #### YOUR CODE HERE
        ax.set_title('Cumulative Business Applications Over Time')
        ax.set_xlabel('Date')
...
def root():
    ...
    # Return the result
    #### YOUR CODE HERE
    return report(1, Employee(DB_PATH))
...
def employee(id: str):
    ...
    # Return the result
    #### YOUR CODE HERE
    return report(int(id), Employee(DB_PATH))
...
def team(id: str):
    ...
    # Return the result
    #### YOUR CODE HERE
    return report(int(id), Team(DB_PATH))
...
def update_dropdown(r):
    ...
    if r.query_params['profile_type'] == 'Team':
        return dropdown(None, Team(DB_PATH))
    elif r.query_params['profile_type'] == 'Employee':
        return dropdown(None, Employee(DB_PATH))
